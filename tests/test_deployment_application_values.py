...
class DeploymentApplicationValueTests(unittest.TestCase):
    ...
    def test_acceptance_corpus_exercises_all_four_deploy_transition_forms(self) -> None:
        scenarios = {scenario.scenario_id: scenario for scenario in planning_scenarios()}
        expected = {
        ...
        for scenario_id, transition_type in expected.items():
