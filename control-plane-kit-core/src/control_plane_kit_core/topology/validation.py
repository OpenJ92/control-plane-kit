...
from control_plane_kit_core.control_routes import route_set_named
from control_plane_kit_core.topology.graph import DeploymentGraph
from control_plane_kit_core.topology.codec import (
    DEFAULT_GRAPH_CODEC,
...
class GraphValidationPolicy:
    """Pure graph validation policy.

    Product-catalogue admission policies are external to the core kernel and
    should be applied by registered product interpreters or operation services.
    """
