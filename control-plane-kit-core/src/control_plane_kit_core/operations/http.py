    ...
    return tuple(
        ...
        for (
            ...
            (
                ...
                "/workspaces/{workspace_id}/delegation-keys/{issuer}/{key_id}/activate",
                ControlPlaneServiceRole.PLANNING,
                HttpAuthScope.ADMIN,
                HttpOperationSafety.COMMAND,
            ...
            (
                ...
                "/workspaces/{workspace_id}/delegation-keys/{issuer}/{key_id}/retire",
                ControlPlaneServiceRole.PLANNING,
                HttpAuthScope.ADMIN,
                HttpOperationSafety.COMMAND,
            ...
            (
                ...
                "/workspaces/{workspace_id}/delegation-keys/{issuer}/{key_id}/revoke",
                ControlPlaneServiceRole.PLANNING,
                HttpAuthScope.ADMIN,
                HttpOperationSafety.COMMAND,
            ...
            (
                ...
                "/workspaces/{workspace_id}/gateway-key-rotations/{rotation_id}/approval",
            ...
            (
                ...
                "/workspaces/{workspace_id}/gateway-key-rotations/{rotation_id}/decision",
                ControlPlaneServiceRole.APPROVAL,
            ...
            (
                ...
                "/workspaces/{workspace_id}/gateway-key-rotations/{rotation_id}/advance",
                ControlPlaneServiceRole.PLANNING,
                HttpAuthScope.EXECUTION_RUN,
                HttpOperationSafety.COMMAND,
