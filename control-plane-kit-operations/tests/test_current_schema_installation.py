...
_CURRENT_CONTRACT_SHA256 = (
    "caef8132f8650be436601eed12a64f51df78df9ce1ba9770bce0db2ec9524320"
)
_CURRENT_SCHEMA_SQL_SHA256 = (
    "e0ae08c572cd416260bf572e93da1b66f86d22aaa1fb38c00c36340f5b50cace"
)
...
class CurrentSchemaInstallationTests(unittest.TestCase):
    ...
    def test_object_free_install_creates_only_exact_current_truth(self) -> None:
        ...
        self.assertEqual(self._catalog_counts(), (39, 503, 379, 125))
        self.assertEqual(
