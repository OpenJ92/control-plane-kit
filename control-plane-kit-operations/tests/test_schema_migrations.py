...
class SchemaMigrationLanguageTests(unittest.TestCase):
    ...
    def test_v1_baseline_checksum_and_package_exports_are_frozen(self) -> None:
        ...
        self.assertEqual(len(registry.migrations), 16)
        ...
        self.assertEqual(registry.migrations[4].version, 5)
        self.assertEqual(
            registry.migrations[4].name,
        ...
        self.assertEqual(registry.migrations[6].version, 7)
        self.assertEqual(
            registry.migrations[6].name,
            "gateway-key-rotation-timestamps",
        )
        self.assertEqual(registry.migrations[7].version, 8)
        self.assertEqual(
