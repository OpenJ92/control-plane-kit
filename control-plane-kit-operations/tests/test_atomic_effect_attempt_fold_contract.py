...
EXACT_INTERPRETER_IMPORTS = tuple(
    ...
    for value in (
        ...
        ("control_plane_kit_core.planning", "resolve_management_observation", None),
        ("control_plane_kit_core.policies", "ApprovalPolicy", None),
        ...
        ("control_plane_kit_core.topology", "validate_graph", None),
        (
        ...
        ("control_plane_kit_operations.effect_attempt_fold", "_valid_health_fold", None),
        ("control_plane_kit_operations.effect_attempt_fold", "_valid_native_fold", None),
        (
        ...
        ("control_plane_kit_operations.records", "ActivityPlanStatus", None),
        ("control_plane_kit_operations.records", "ApprovalDecisionKind", None),
        ...
        ("control_plane_kit_operations.runtime_management_targets", "is_signed_management_health_operation", None),
        (
...
# Enumerated native acceptance calls remain inside pure validation and the
# existing caller-owned transaction. This is not a provider-dispatch allowance.
EXACT_INTERPRETER_CALLS = (
    architecture_testing.UnresolvedCallTarget(),  # closed unsupported/uncertain constructor selection
    ...
    *tuple(
        ...
        for value in (
            ...
            "_execute_fold",
            "_fold",
            "_native_read_failure_outcome",
            "_native_read_failure_outcome",
            "_observation",
            "_observation",
            "_prepare_native_fold",
            ...
            "control_plane_kit_core.policies.ApprovalPolicy",
            "control_plane_kit_core.runtime_effects.RuntimeEffectFailure",
            "control_plane_kit_core.topology.DEFAULT_GRAPH_CODEC.decode",
            "control_plane_kit_core.topology.validate_graph",
            *("control_plane_kit_operations.effect_attempt_fold.EffectAttemptFoldConflict",) * 27,
            *("control_plane_kit_operations.effect_attempt_fold.EffectAttemptFoldDenied",) * 14,
            *("control_plane_kit_operations.effect_attempt_fold.EffectAttemptFoldNotFound",) * 3,
            ...
            "control_plane_kit_operations.effect_attempt_fold._valid_health_fold",
            "control_plane_kit_operations.effect_attempt_fold._valid_native_fold",
            ...
            "control_plane_kit_operations.effect_outcome_evidence.ExecutionEffectOutcome",
            "control_plane_kit_operations.effect_outcome_evidence.NativeConnectionEffectOutcome.from_observation",
            ...
            *("control_plane_kit_operations.workflows.InvalidOperationCommand",) * 5,
            ...
            "signing_authority.in_unit_of_work",
            "stores.activity_history.approval_decision_for_request",
            ...
            "stores.execution.get_latest_run_for_request_for_update",
