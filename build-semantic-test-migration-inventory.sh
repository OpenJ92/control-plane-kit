...
COORDINATION_REF="${CPK_COORDINATION_INVENTORY_REF:-9007e435444a9bd3e8cbf507f64747f7d791d987}"
INTERPRETERS_REF="${CPK_INTERPRETERS_INVENTORY_REF:-d36788e24dcf0c43f49c398d9e01ab02ad453f02}"
SERVERS_REF="${CPK_SERVERS_INVENTORY_REF:-00eeeada9bc19e86944836e1f5dfe15ee9524971}"
SECRETS_REF="${CPK_SECRETS_INVENTORY_REF:-553f01c4391223db076e196ac865759e8ce1eb9a}"
