...
The [initial inventory](inventory.json) covers 310 tracked implementation, test, schema and meaningful process/build inputs: twenty-eight reviewed companions, 279 pending entries and three exclusions. Existing guidance is maintained directly rather than recursively mirrored. The reviewed notes cover attempt-intent admission/history, runtime translation/bootstrap, execution/rotation-child admission, approval requests/decisions, read-service foundations, authority/secret/gateway projections and observation freshness; the PR records independent review depth. Pending means rollout work, not certified absence of defects or a reason to block unrelated work.
